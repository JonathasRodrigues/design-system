...
export const Orbita = () => {
  ...
  const onWebsiteChange = (value: any) => {
    if (!value) {
      ...
      setAutoCompleteResult(['.com', '.org', '.net'].map((domain: string) => `${value}${domain}`));
    }
  };
  ...
  >
    ...
    <Form.Item
      ...
      label={
        <span>
          Nickname&nbsp;
          <Tooltip title="What do you want others to call you?"><span>?</span></Tooltip>
        </span>
      }
